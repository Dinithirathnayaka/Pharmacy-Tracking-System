        ...
        <div className="container pt-3 pb-3">
          ...
          <div className="row">
            ...
            <div className="col-md-3 col-xs-12 p-2">
              {" "}
              <h5>SERVICES</h5>
              <div className="mb-2 text-bold">Search Medicine</div>
              <div className="mb-2">Find Pharmacy</div>
              <div className="mb-2">Meet Doctor</div>
            </div>
            ...
            <div className="col-md-3 col-xs-12 p-2">
              ...
              <div className="mb-2">
                ...
                <span>203 Fake St. Mountain View, USA</span>
              </div>
              <div className="mb-2">
